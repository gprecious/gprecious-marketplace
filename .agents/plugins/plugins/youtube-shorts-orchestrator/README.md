...
- **트렌딩 기반 주제 수집** (YouTube Trending, Google Trends)
- **연령별/국가별 컨텐츠 전략** (content-bank/ 참조)
- 뇌과학 기반 도파민 트리거 최적화
- 극단적 시청자 페르소나 검증
- **스크립트 자동 번역** (문화적 로컬라이제이션)
- **언어/채널 맞춤 음성 자동 선택** (ElevenLabs)
- **AI 후킹 영상 생성** (Replicate Wan 2.2 / DALL-E fallback)
- **저작권 무료 영상 소스** (Pexels, Pixabay만 사용)
...
Phase 2에서 자동으로 트렌딩 데이터를 수집합니다:

- **YouTube Trending**: 국가별 인기 영상 분석
- **Google Trends**: 실시간 검색어 트렌드
- **연령별 카테고리 필터링**: 타겟에 맞는 주제 선별

설정 파일: `content-bank/trending-config.json`

### 연령별 선호 컨텐츠

| 연령대 | 1순위 컨텐츠 | 감정 트리거 | 페이스 |
|--------|-------------|------------|--------|
| **Young** | 코미디/밈, 트렌드 | FOMO, 서프라이즈 | 빠름 (1.5초 훅) |
| **Middle** | How-to, 재테크, 건강 | 성취감, 실용적 가치 | 중간 (3초 훅) |
| **Senior** | DIY/취미, 뉴스, 음악 | 노스탤지어, 따뜻함 | 느림 (5초 훅) |
...
|------|------------|-----------|
| 🇰🇷 한국 | 유머/개그 (48%) | 집단적, 귀여움 |
| 🇺🇸 미국 | 코미디/밈 (67%) | 아이러니, 직접적 |
| 🇯🇵 일본 | 카와이, 만족감 | 부드럽고 섬세 |
| 🇨🇳 중국어권 | 교육/실용 | 긍정적, 집단적 |
| 🇪🇸 스페인어권 | 감성, 음악/댄스 | 따뜻함, 슬랩스틱 |
| 🇧🇷 포르투갈어권 | 음악/댄스, 축제 | 축제적, 따뜻함 |
| 🇩🇪 독일 | How-to, 품질 | 위트, 지적 |
| 🇫🇷 프랑스 | 문화/미식, 미학 | 세련됨 |

자세한 전략: `content-bank/content-strategy.md`

### 저작권 안전 영상 소스

| 소스 | 상태 | 용도 |
|------|------|------|
| **Pexels** ✅ | Primary | 스톡 영상 (동물, 자연, 사람) |
| **Pixabay** ✅ | Backup | 스톡 영상 + BGM |
| **AI 생성** ✅ | 훅 영상 | Replicate Wan 2.2 |
| YouTube CC-BY ❌ | **금지** | Content ID 위험 |
| TikTok/Instagram ❌ | **금지** | 저작권 침해 |
